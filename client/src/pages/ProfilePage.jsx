    ...
    <div className="profile-page">
      ...
      <div className="profile-header">
        ...
        <div style={{ flex: 1 }}>
          ...
          {/* User ID row — shown for ALL users including Google sign-in */}
          ...
          <div className="profile-actions">
            {isOwn ? (
              <>
                ...
                {/* Change/Set Password button — visible for all own-profile views */}
                <button className="btn btn-secondary btn-sm" onClick={() => { setSetPassOpen(true); setPassErr(''); setCurrentPass(''); setNewPass(''); setConfirmPass(''); }}
        ...
        <Modal title="Delete Account" onClose={() => { setDeleteOpen(false); setDeleteConfirm(''); }}>
          ...
          <div className="form-group">
            ...
            <input className="form-input" value={deleteConfirm}
              ...
              style={{ borderColor: deleteConfirm === 'DELETE' ? '#e74c3c' : undefined }} />
          </div>
          <div style={{ display: 'flex', gap: 10, marginTop: 8 }}>
            <button className="btn btn-secondary btn-full"
            ...
            <button
              ...
              style={{ flex: 1, padding: '11px', borderRadius: 8, border: 'none',
                background: deleteConfirm === 'DELETE' && !deleting ? '#e74c3c' : 'rgba(231,76,60,0.3)',
